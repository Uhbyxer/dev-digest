...
/** Co-located styles for SkillsLabView (mirrors AgentsListView). */
export const s = {
  ...
  previewMeta: { display: "flex", gap: 8, marginBottom: 16 } satisfies CSSProperties,
  previewActions: { display: "flex", gap: 8, marginBottom: 16 } satisfies CSSProperties,
  previewDescription: {
    fontSize: 13,
